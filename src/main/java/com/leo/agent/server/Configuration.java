...
import com.leo.agent.protocol.request.XRequestResolverFactory;
import com.leo.agent.server.cache.DnsGuavaCache;
import com.leo.agent.util.tunnel.SocketTunnel;
import com.leo.agent.wrapper.Wrapper;
import com.leo.agent.wrapper.WrapperFactory;
...
public class Configuration {
    ...
    public static void init() throws Exception {
        ...
        DnsGuavaCache.init(INSTANCE.dnsCacheCapacity);
